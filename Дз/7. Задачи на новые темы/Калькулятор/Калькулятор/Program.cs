...
namespace Обучение_.Net
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (workСalculator)
            {
                ...
                else
                {
                    ...
                    Console.WriteLine(OperationSelection(operand1, operation, operand2));
                }
            }
        ...
        public static double OperationSelection(double operand1, string operation, double operand2)
        {
            double result = 0;
