...
namespace MyNewLogger
{
    ...
    public class ConsoleLogger : Ilogger
    {
        ...
        {
            Console.WriteLine(message + " ConsLogInformation");
        }
    ...
    public class FileLogger : Ilogger
    {
        ...
        public void LogInformation(string message)
        {
            ...
            {
                writer.WriteLine(message + " FileLogInformation");
            }
        }
    ...
    public class CompositeLogger : Ilogger // необходимы поянения ко всей этой хуйне
    {
        ...
        public void LogInformation(string message)
        {
            _consoleLogger.LogInformation(message + "CompLogInformation");
